...
$food-> appendChild($menu-> createElement('description', "Two of our famous Belgian waffles with plenty of maple sirup"));
...
$food-> appendChild($menu-> createElement('price', "$5.95"));
$food-> appendChild($menu-> createElement('description', "Light Belgian Waffles with strawberry whipped cream"));
