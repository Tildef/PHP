...
/*
    * Spara undan en cookie med angivet namn
    * @param string $namn
    * @return void
*/

function sparaNamn(string $namn):void {
    //Sätter cookie 'namn' till värdet på inparameter
    setcookie('namn', $namn);
 ...
 *@spara array $post element tarning_§=on betyder att tärningen ska slås om
