...
//Jämför de 20 slumpade tal med 11 imatade tal och berätta hur många som var rätt

if (isset($_POST['minaTal'])) {
	//Skapa en array av de immatade talen
	...
	if (count($minaTal)!==11) { //Det är inte 11 tal i arrayen
		...
		for ($i=0; $i<11; $i++) { //Kolla att det är heltal mellan 1 och 70
			if(!is_int((int)$minaTal[$i]) || $minaTal[$i]>70 || $minaTal[$i]<1) { //int= gör om det till heltal
	...
	echo "<br><br> Du fick $antalRatt rätta tal!";
